...
While !Eof() .And. C5_NUM == mv_par01
 ...
 //	oPrn:Say(0680,0900,"Formato"   	            	,oFont12N) campo customizado
 //	oPrn:Say(0680,1080,"Gramatura"  	            ,oFont12N)campo customizado
 //	oPrn:Say(0680,1300,"N folhas"	                ,oFont12N)campo customizado
	oPrn:Say(0680,1500,"Fabricante"	                ,oFont12N)
  //oPrn:Say(0680,1700,"N Bobinas"	                ,oFont12N) campo customizado
	...
	While !Eof() .And. C6_NUM ==SC5->C5_NUM
	  ...
	  //oPrn:Say(nLin,930,OemToAnsi(SC6->C6_XFORMAT),          oFont08)   campo customizado
     //	oPrn:Say(nLin,1140,OemToAnsi(SC6->C6_XGRAMAT),         oFont08)   campo customizado
		cFabric2:=substr(cFabricante,01,08)
	//	oPrn:Say(nLin,1340,Transform(SC6->C6_XFOLHA,"@E 999",),oFont08)   campo customizado
  ...
  //oPrn:Say(1450,0680,OemToAnsi(SC5->C5_XOBS2),oFont12)   campo customizado
 //	oPrn:Say(1500,0680,OemToAnsi(SC5->C5_XOBS3),oFont12)   campo customizado
//	oPrn:Say(1550,0680,OemToAnsi(SC5->C5_XOBS),oFont12)    campo customizado
